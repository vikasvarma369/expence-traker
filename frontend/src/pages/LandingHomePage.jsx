...
export function LandingHomePage() {
  ...
  return (
    <>
      {/* Top Ribbon Header for a Message */}
      <div className="bg-blue-600 text-white text-center py-2 w-full fixed top-0 left-0 z-50">
        This site runs on a free tier. To avoid suspensions, background jobs have been removed, which may cause slower performance.
      </div>
      <WavyBackground className="max-w-4xl mx-auto pb-40 px-4 mt-12">
        {/* Heading */}
